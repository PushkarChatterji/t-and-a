...
export default function TeacherMonitorPage() {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      <h1 className="text-2xl font-bold text-slate-900 mb-2">Monitor Students</h1>
      <p className="text-slate-500 text-sm mb-6">Track progress and engagement across your classes.</p>

      <div className="mb-6">
        <select
          value={selectedClass}
          onChange={e => setSelectedClass(e.target.value)}
          className="border border-slate-300 rounded-lg px-3 py-2 text-sm text-black w-64"
        >
      ...
      {!selectedClass && !loading && (
        <div className="text-center py-16 text-slate-400">
          ...
          <p>Select a class to view student metrics</p>
        </div>
      )}
    </div>
  );
